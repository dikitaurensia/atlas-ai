          ...
          <form onSubmit={handleSubmit}>
            <div className={styles.fields}>
              <div className={styles.fieldRow}>
                ...
                <div className={styles.field}>
                  <label className={styles.label}>Nama Bisnis</label>
                  <input
              ...
              <div className={styles.field}>
                ...
                {errors.password
                  ...
                  : <span className={styles.passwordHint}>Minimal 8 karakter</span>
                }
              </div>
            ...
            <p className={styles.terms}>
              ...
              <a href="#" className={styles.termsLink}>Syarat & Ketentuan</a> dan{' '}
              <a href="#" className={styles.termsLink}>Kebijakan Privasi</a> ESB AtlasAI.
            </p>

            <button type="submit" className={styles.submitBtn} disabled={loading}>
              {loading ? <><span className={styles.spinner} />Membuat akun…</> : 'Daftar Sekarang'}
            </button>
          </form>
    ...
    <div className={styles.left}>
      ...
      <div className={styles.leftBody}>
          ...
          <div className={styles.sceneGroup}>
            ...
            <div className={styles.mapCard}>
              ...
              <svg width="262" height="140" viewBox="0 0 262 140">
                <defs>
                  <radialGradient id="lv2" cx="50%" cy="50%" r="50%">
                ...
                <rect width="262" height="140" fill="url(#lv2)"/>
              </svg>
            </div>
        ...
        <p className={styles.leftDescSmall}>
          Daftar gratis dan mulai analisis lokasi bisnis FnB-mu —<br/>
          data real ESB, skor AI, kompetitor dalam hitungan detik.
        </p>
      </div>
