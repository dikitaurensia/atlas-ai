...
const TAG_STYLES = {
  ...
  info:     { bg: '#EFF6FF', color: '#1B3566', bd: '#BFDBFE' },
          ...
          <div ref={previewRef} style={{ ...s.page, zoom: pageScale }}>
            ...
            <div style={s.banner}>
              <div style={s.bannerLeft}>
                ...
                <div>
                  <div style={s.bannerBrand}>Atlas<span style={{ color: '#1B3566' }}>AI</span></div>
...
const s = {
  ...
  dlBtn: {
    ...
    boxShadow: '0 3px 10px rgba(27,53,102,0.35)',
  ...
  bannerLogo: {
    ...
    background: 'linear-gradient(135deg,#1B3566,#4A6FA5)',
    display: 'flex', alignItems: 'center', justifyContent: 'center',
  },
  ...
  bannerDocType: { fontSize: 9, fontWeight: 800, letterSpacing: '1px', color: '#1B3566' },
  ...
  locIcon: { fontSize: 13 },
  locCat: { fontSize: 11, fontWeight: 700, color: '#1B3566' },
  coordStrip: {
  ...
  profitRange: { fontSize: 18, fontWeight: 800, color: '#1B3566', marginBottom: 4, lineHeight: 1 },
